...
__bpf_kfunc int bpf_kfunc_with_implicit_arg(int foo, const struct bpf_prog_aux *aux)
{
	if (aux && foo > 0)
		return 0;
	else
...
BTF_ID_FLAGS(func, bpf_kfunc_with_implicit_arg, KF_IMPLICIT_ARGS | KF_FASTCALL)
